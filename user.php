    ...
    if (mysqli_num_rows($emailCheckResult) > 0) {
        ...
        if (empty($message)) {
            if ($isEdit) {
                ...
                $message .= ($result && mysqli_affected_rows($conn) > 0) ? "User updated successfully.<br>" : "No changes were made.<br>";
            } else {
...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="card p-4">
                <h2 class="text-center"><?= $isEdit ? "Update User" : "Add New User" ?></h2>
